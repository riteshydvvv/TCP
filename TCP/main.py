...
[FFFFFF]          ⚡ RITESH YADAV❤️  
[FFFFFF]                   thank for support 
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]RITESH YADAV    
[FFD700]✨ Name on tiktok : [FFFFFF] 9x_jubayer_❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> RITESH YADAV ❄️  ⚡
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "RITESH YADAV", key, iv)
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To ᴹRitesh Cheats"
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]RITESH YADAV
...
async def MaiiiinE():
    Uid , Pw = '4359047385','6CE21F797A13EC4B688AC5300089D240F327A3119247BBE0F9B766DA239865C1'
    ...
    os.system('clear')
    print("Initializing RITESH YADAV Bot...")
    print("┌────────────────────────────────────┐")
    print("│ SUBSCRIBER ON │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    ...
    print("🤖 RITESH YADAV BOT - ONLINE")
    print("┌────────────────────────────────────┐")
    print("│ SUBSCRIBER  ON  YOUTUBE  : RITESH YADAV │")
    print("└────────────────────────────────────┘")
    print(f"🔹 UID: {TarGeT}")
    ...
    os.system('clear')
    print(render('RITESH YADAVs', colors=['white', 'green'], align='center'))
    print('')
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using RITESH YADAV")
    sys.exit(0)
